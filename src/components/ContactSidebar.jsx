...
const ContactSidebar = ({ isOpen, onClose }) => {
    ...
    return (
        <>
            ...
            />
            <aside
                className={`contact-sidebar ${isOpen ? 'open' : ''}`}
                id="contact"
            ...
            >
                ...
                <div className="contact-detail-list">
                    <div className="contact-detail-item">
                        ...
                        <a href="mailto:educationsukha@gmail.com">educationsukha@gmail.com</a>
                    </div>
                    <div className="contact-detail-item">
                ...
                <div className="contact-social">
                    ...
                    <div className="contact-social-links">
                        <a
                            href="https://www.instagram.com/sukhaeducationfoundation?igsh=ZXh2MjdwZzY2MDg0"
                            target="_blank"
                            rel="noopener noreferrer"
                        ...
                        <a
                            href="https://www.linkedin.com/company/sukhaeducation/"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="contact-social-btn"
                            aria-label="LinkedIn"
